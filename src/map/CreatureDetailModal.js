          ...
          <View style={{ flexDirection: "row", marginLeft: 21 }}>
            ...
            <View style={{ marginLeft: 13, flexShrink: 1 }}>
              <View style={{ flexDirection: "row" }}>
                <Text style={style.specific.text}>
                  {animalData.creatureName}
                </Text>
                <Text style={style.specific.specificText}>
              ...
              <Text
                ...
                numberOfLines={0}
              >
                {animalData.creatureInformation.length > 20
                  ? animalData.creatureInformation.slice(0, 50)
