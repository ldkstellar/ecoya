...
import url from "../Url";
import { useQuizModal } from "./use-Modal";
...
const Quiz = () => {
  ...
  function fetchPostAddData() {
    ...
    try {
      // 수정 해야되는 곳
      const tmp = { ...userData };
      tmp.correctCount = tmp.correctCount >= 2 ? 3 : 0;
      axios.post(myUrl, tmp).then((response) => {
        ...
        <View style={{ justifyContent: "center", alignItems: "center" }}>
          ...
          >
            <Text style={{ textAlign: "center" }}>
              {quizNum === 4 ? "친구가 되었을까요?" : "다음 퀴즈를 풀래요!"}
            </Text>
          </TouchableOpacity>
          <Heihgt height={12} />
        </View>
  ...
  return (
    ...
    >
      ...
      <View style={{ justifyContent: "center", alignItems: "center" }}>
        ...
        <View
          style={{ width: 280, borderColor: "#333333", borderBottomWidth: 0.8 }}
        >
          <Text
            style={{
              textAlign: "center",
